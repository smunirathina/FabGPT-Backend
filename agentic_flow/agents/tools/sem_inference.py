...
from agents.tools.describeDefect import describe_sem_defect_types

# Set device (GPU if available, else CPU)
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# Load the trained model
model_path = "/home/sbna/Documents/WaferGPT-Backend/models/vit_model_best_sem_with_non_26_new.pth"  # Change this if using a different saved model
