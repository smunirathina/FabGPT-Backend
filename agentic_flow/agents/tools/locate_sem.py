import cv2,os,uuid
import numpy as np
from agents.tools.describeDefect import describe_defect_location
from agents.tools.identify_category import compare_images
from agents.tools.locate_line import locate_sem_line_defect

def locate_sem_defect(defect_path):

    if compare_images(defect_path) > 0.2:
        return locate_sem_line_defect(defect_path)
    else:

        # Load images
        ideal_path = "/home/sbna/Documents/WaferGPT-Backend/png_files/sem1.png"  # Ideal wafer image
